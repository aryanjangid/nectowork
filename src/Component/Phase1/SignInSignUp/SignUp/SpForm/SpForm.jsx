...
function SpForm({onSignUpClose}) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (values.First_Name && values.Last_Name && values.Buisness_Email_ID && values.Password && values.Confirm_Password && values.Organization_Name && values.Phone_Number) {
