...
import "./SpRequirementPostedHired.css";
...
function SpRequirementPostedHired() {
    ...
    return (<Fragment>
        <div className="SpRequirementPostHired">
        <h1 className="hired-business-partner-text">Hired Business Partners</h1>
            <hr className="hired-tab-line"/>
            <div className={"all-hired-business-partner-wrapper"}>
                <div className="all-hired-business-partner-tabs">
                    <h3>Requirement: Chatbot Solution</h3>&nbsp;
                    <p>Posted on 18<sup>th</sup>July 2021</p>
                </div>
                <hr className="hired-tab-line"/>
                <div className={"my-requirement-hired-section"}>
                    <div className={"my-requirement-hired-section-first"}>
                        <h3>Harsh Babbar</h3>
                    ...
                    <div className={"my-requirement-hired-section-second"}>
                        <div className={"my-requirement-hired-section-second-left"}>
                        ...
                        <div className={"my-requirement-hired-section-second-right"}>
...
export default SpRequirementPostedHired
